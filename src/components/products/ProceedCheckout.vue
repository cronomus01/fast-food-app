<template>
    <ion-button fill="solid" color="primary" expand="block" slot="fixed" @click="setOpen(true)"> Add to Bag </ion-button>
    <ion-modal ref="modal" :is-open="isOpen">
      <ion-header class="ion-no-border proceed-checkout-header">
        <ion-toolbar>
          <ion-buttons slot="start">
            <ion-button @click="setOpen(false)" class="cancel" color="medium">Cancel</ion-button>
          </ion-buttons>
      ...
      <ion-content class="ion-padding">
        ...
        <ion-item-group class="check-out-group">
          ...
          <ion-buttons>
            <ion-button fill="solid" color="primary" @click="setOpen(false)">Proceed to Checkout</ion-button>
            <ion-button fill="clear" color="primary" @click="setOpen(false)" router-link="/products">Add More</ion-button>
          </ion-buttons>
        </ion-item-group>
      </ion-content>
    </ion-modal>
...
import { IonModal, IonContent, IonItemGroup, IonButtons, IonButton, IonImg, IonHeader,IonToolbar, IonTitle, } from '@ionic/vue';
